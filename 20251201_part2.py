...
def solve(input_string: str) -> int:
    ...
    for line in lines:
        ...
        # if we passed a zero, count it
        step = 1 if current_value > previous_value else -1
        for val in range(previous_value + step, current_value + step, step):
            if list_of_100_values[val % 100] == 0:
                result += 1
